...
const LessonListPage = async ({ searchParams }: { searchParams: any }) => {
  // Await searchParams
      ...
      if (value !== undefined) {
        switch (key) {
          case "classId":
            ...
            break;
          case "teacherId":
            query.teachers = { some: { id: value as string } };
            break;
          case "search":
            query.OR = [
              { subject: { name: { contains: value as string, mode: "insensitive" } } },
              { teachers: { some: { name: { contains: value as string, mode: "insensitive" } } } },
            ];
            break;
          default:
            break;
