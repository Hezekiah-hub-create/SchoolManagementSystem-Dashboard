...
import { resultFormSchema, ResultFormSchema } from '@/lib/formValidationSchemas';
  ...
  const action = async (formData: FormData) => {
    startTransition(async () => {
      try {
        ...
        if (data.assignmentId) data.assignmentId = parseInt(data.assignmentId);
        if (data.id) data.id = parseInt(data.id);

        const result = type === 'create' ? await createResult(data) : await updateResult(data);
